...
function fixtureContiniousFillScenario(limit, tag_keys) {
    ...
    if ( targetQuantity <= config.fixtureFill.random ) { console.log([locale.fixture_fill_need[0], (config.fixtureFill.random*2+1), locale.fixture_fill_need[1]].join(' ')); return 0; }
    parking.clear();
    var quantity = 0;
